%%%----------------------------------------------------------------
%%% @author  Jordan Wilberding <diginux@gmail.com>
%%% @doc
%%% @end
%%% @copyright 2009 Jordan Wilberding
%%%----------------------------------------------------------------
-module(eflickr_gui).
...
test1 () ->
    gen_server:call (?SERVER, {test1}).

test2 (Txt) ->
    gen_server:cast (?SERVER, {test2, Txt}).    
...
%%--------------------------------------------------------------------
handle_cast({test2, Txt}, State) ->
    io:format("test2: ~s called!~n", [Txt]),
    {noreply, State};
